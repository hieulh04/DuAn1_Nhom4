...
public class MayRepository {
    ...
    public static int Update(MayViewModel x) {
        ...
        return JDBC_Helper.updateTongQuat(sql,x.getTenLoaiMay(), x.getDonGiaMay());
    }
    ...
    public static int Insert(MayViewModel x) {
        ...
        return JDBC_Helper.updateTongQuat(sql, x.getTenLoaiMay(), x.getMaMay(), x.getTrangThai());
    }

    public static int Delete(MayViewModel x) {
        String sql = "delete from may where mamay=?";
        return JDBC_Helper.updateTongQuat(sql, x.getMaMay());
    }
